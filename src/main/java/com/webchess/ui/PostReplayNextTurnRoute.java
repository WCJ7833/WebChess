...
/**
 * The {@code POST /replay/nextTurn} route handler.
 *
...
public class PostReplayNextTurnRoute implements Route {
    ...
    /**
     * The constructor for the {@code POST /replay/nextTurn} route handler.
     *
     * @param templateEngine
     *    The {@link TemplateEngine} used for rendering page HTML.
     */
    PostReplayNextTurnRoute(final TemplateEngine templateEngine, final GameCenter gameCenter, final Gson gson) {
        // validation
     ...
     *
     * @return
     *   the appropriate message for showing the next replay turn
     */
    @Override
