...
public class WebServer {
  ...
  public static final String REPLAY_NEXTTURN_URL = "/replay/nextTurn";
  public static final String REPLAY_PREVIOUSTURN_URL = "/replay/previousTurn";
  public static final String REPLAY_STOPWATCHING_URL = "/replay/stopWatching";
  ...
  public void initialize() {
    ...
    get(REPLAY_URL,new GetReplayRoute(templateEngine,gameCenter, gson));
    get(REPLAY_STOPWATCHING_URL, new GetReplayStopWatchingRoute(templateEngine,gameCenter,gson));
    post(SIGNOUT_URL, new PostSignOutRoute(templateEngine,gameCenter));
    post(HOME_URL, new PostHomeRoute(templateEngine, gameCenter, gson));
    post(GAME_URL, new PostGameRoute(templateEngine, gameCenter));
    post(VALIDATEMOVE_URL,new PostValidateMoveRoute(templateEngine,gameCenter,gson));
    post(CHECKTURN_URL,new PostCheckTurnRoute(templateEngine,gameCenter,gson));
    post(RESIGNGAME_URL, new PostResignGameRoute(templateEngine,gameCenter,gson));
    post(SUBMITTURN_URL, new PostSubmitTurnRoute(templateEngine,gameCenter,gson));
    post(BACKUPMOVE_URL, new PostBackupMoveRoute(templateEngine,gameCenter,gson));
    post(REPLAY_NEXTTURN_URL, new PostReplayNextTurnRoute(templateEngine,gameCenter,gson));
    post(REPLAY_PREVIOUSTURN_URL, new PostReplayPreviousTurnRoute(templateEngine,gameCenter,gson));
